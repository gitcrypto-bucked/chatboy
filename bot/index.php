...
<div class="chatbot chatbot--closed ">
    <div class="chatbot__header">
        <p><strong>Prcisa de Ajuda?</strong> <span class="u-text-highlight">Pergunte a Hazel</span></p>
    ...
    <div class="chatbot__message-window">
        <ul class="chatbot__messages">
            <li class="is-ai animation">
                ...
                <p class='chatbot__message'><strong class='intro'>Olá, eu sou Hazel, sua assistente virtual. Estou aqui para ajudar com suas dúvidas gerais
                    .</strong>Examplo de perguntas que você pode pedir: <br><em>Olá / Como fazer um cadastro </em></p>
            </li>
            <!-- Message here -->
        </ul>
    </div>
    <div class="chatbot__entry chatbot--closed">
        <input type="text" class="chatbot__input" placeholder="Escreva sua mensagem..." />
...
<svg>
      ...
      <symbol id="avatar" width="44.25" height="44" viewBox="0 0 44.25 44">
        <title>Avatar</title>
        <path style="fill: #145DA0; fill-rule: evenodd;" d="M1035.88,1696.25a22,22,0,1,1-22.13,22A22.065,22.065,0,0,1,1035.88,1696.25Z" transform="translate(-1013.75 -1696.25)"/>
